...
const Excute = async function(User, pckUsername, TargetUsername, Usernames, sleep, mysyntx){
  try {
    ...
    do {
      ...
      var Text = fs.readFileSync('./tools/commentText.txt', 'utf8').split('|');
        ...
        console.log(chalk`{bold.red \n [#][>] Jeda ${hasil.toFixed(2)} menit [|] } {bold.yellow Akun : ${Usernames} } {bold.magenta [|] Followers : [${getpiceksu.followers}] Following : [${getpiceksu.following}] [|]} {bold.green [|] Dengan target : ${TargetUsername} [<][#] }\n`);
        await delay(sleep);
      }
...
console.log(chalk`
  ...
  [✓] ADDING FITURE DETECT UNAME BY SANDRO PUTRAA                                                                          
  ...
  —————————————————————————————————————————————————————}
      `);
//sandro.putraaXyahyahamid(ReEditOutputMinutes)
